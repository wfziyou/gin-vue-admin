...
func (appUserBrowsingHistoryService *AppUserBrowsingHistoryService) CreateHkUserBrowsingHistory(hkUserBrowsingHistory general.HkUserBrowsingHistory) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserBrowsingHistoryService *AppUserBrowsingHistoryService) DeleteHkUserBrowsingHistory(hkUserBrowsingHistory general.HkUserBrowsingHistory) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserBrowsingHistoryService *AppUserBrowsingHistoryService) DeleteHkUserBrowsingHistoryByIds(ids request.IdsReq) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserBrowsingHistoryService *AppUserBrowsingHistoryService) UpdateHkUserBrowsingHistory(hkUserBrowsingHistory general.HkUserBrowsingHistory) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserBrowsingHistoryService *AppUserBrowsingHistoryService) GetHkUserBrowsingHistory(id uint) (hkUserBrowsingHistory general.HkUserBrowsingHistory, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserBrowsingHistoryService *AppUserBrowsingHistoryService) GetHkUserBrowsingHistoryInfoList(info generalReq.HkUserBrowsingHistorySearch) (list []general.HkUserBrowsingHistory, total int64, err error) {
	limit := info.PageSize
