...
type CreateForumPostsReq struct {
	...
	TopicId         uint64 `json:"topicId" form:"topicId" gorm:"type:bigint(20);column:topic_id;comment:话题_编号;"`                    //话题_编号
...
type GetRecommendPostsSearch struct {
	ChannelCode string `json:"channelCode" form:"channelCode" ` //频道标识
	request.PageInfo
}
