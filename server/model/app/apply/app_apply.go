...
type Apply struct {
	...
	OwnerType       int                  `json:"ownerType" form:"ownerType" gorm:"column:owner_type;comment:拥有者：0平台、1圈子、2个人;size:10;"`           //拥有者：0平台、1圈子、2个人
	...
	ProgramId       string               `json:"programId" gorm:"-"`                                                                             //程序id
	MiniProgram     *MiniProgramBaseInfo `json:"miniProgram" gorm:"-"`                                                                           //小程序
}
