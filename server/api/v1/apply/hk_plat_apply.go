...
// @accept application/json
// @Produce application/json
// @Param data query apply.HkPlatApply true "用id查询HkPlatApply"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"查询成功"}"
// @Router /hkPlatApply/findHkPlatApply [get]
func (hkPlatApplyApi *HkPlatApplyApi) FindHkPlatApply(c *gin.Context) {
	var hkPlatApply apply.HkPlatApply
	err := c.ShouldBindQuery(&hkPlatApply)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
	if rehkPlatApply, err := hkPlatApplyService.GetHkPlatApply(hkPlatApply.ID); err != nil {
