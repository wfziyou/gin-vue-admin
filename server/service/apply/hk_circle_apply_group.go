...
// Author [piexlmax](https://github.com/piexlmax)
func (hkCircleApplyGroupService *HkCircleApplyGroupService) GetHkCircleApplyGroupInfoListAll(info applyReq.HkCircleApplyGroupSearchAll) (list []apply.HkCircleApplyGroup, total int64, err error) {
	// 创建db
	db := global.GVA_DB.Model(&apply.HkCircleApplyGroup{})
	var hkCircleApplyGroups []apply.HkCircleApplyGroup
	// 如果有条件搜索 下方会自动创建搜索语句
