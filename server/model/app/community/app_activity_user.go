...
type ActivityUser struct {
	...
	NickName    string `json:"nickName" form:"nickName" gorm:"-"`                                            //昵称
	HeaderImg   string `json:"headerImg" form:"headerImg" gorm:"-"`                                          //头像
	Description string `json:"description" form:"description" gorm:"-"`                                      //描述
