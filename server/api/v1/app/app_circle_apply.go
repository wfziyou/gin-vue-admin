...
// @Param data body community.HkUserCircleApply true "创建UserCircleApply"
...
// @accept application/json
// @Produce application/json
// @Param data body community.HkUserCircleApply true "删除UserCircleApply"
...
// @accept application/json
// @Produce application/json
// @Param data query communityReq.HkUserCircleApplySearchAll true "获取UserCircleApply列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
func (circleApplyApi *CircleApplyApi) GetUserCircleApplyListALL(c *gin.Context) {
	var pageInfo communityReq.HkUserCircleApplySearchAll
...
// @accept application/json
// @Produce application/json
// @Param data query applyReq.HkApplySearch true "分页获取Apply列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
// @accept application/json
// @Produce application/json
// @Param data query applyReq.HkApplySearchAll true "获取Apply列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
// @accept application/json
// @Produce application/json
// @Param data query applyReq.HkCircleApplySearch true "分页获取CircleApply列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
// @accept application/json
// @Produce application/json
// @Param data query applyReq.HkCircleApplyGroupSearch true "分页获取CircleApplyGroup列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
// @accept application/json
// @Produce application/json
// @Param data query applyReq.HkCircleApplyGroupSearch true "获取CircleApplyGroup列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
