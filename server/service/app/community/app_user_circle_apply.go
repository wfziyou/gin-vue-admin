...
func (appUserCircleApplyService *AppUserCircleApplyService) CreateHkUserCircleApply(hkUserCircleApply community.HkUserCircleApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserCircleApplyService *AppUserCircleApplyService) DeleteHkUserCircleApply(hkUserCircleApply community.HkUserCircleApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserCircleApplyService *AppUserCircleApplyService) DeleteHkUserCircleApplyByIds(ids request.IdsReq) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserCircleApplyService *AppUserCircleApplyService) UpdateHkUserCircleApply(hkUserCircleApply community.HkUserCircleApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserCircleApplyService *AppUserCircleApplyService) GetHkUserCircleApply(id uint) (hkUserCircleApply community.HkUserCircleApply, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (appUserCircleApplyService *AppUserCircleApplyService) GetHkUserCircleApplyInfoList(info communityReq.HkUserCircleApplySearch) (list []community.HkUserCircleApply, total int64, err error) {
	limit := info.PageSize
