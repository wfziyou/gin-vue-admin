...
type HkChannel struct {
      ...
      FixedType  *bool `json:"fixedType" form:"fixedType" gorm:"column:fixed_type;comment:固定标识(不固定:0，固定:1);"`
      Type  *bool `json:"type" form:"type" gorm:"column:type;comment:类型：0系统 1自定义;"`
