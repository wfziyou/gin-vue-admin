...
// HkActivityClassify 结构体
type HkActivityClassify struct {
      global.GVA_MODEL
...
// TableName HkActivityClassify 表名
func (HkActivityClassify) TableName() string {
  return "hk_activity_classify"
}
