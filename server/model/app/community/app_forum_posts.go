...
type ForumPosts struct {
	...
	TopicId       string               `json:"topicId" form:"topicId" gorm:"column:topic_id;comment:话题_编号,通过逗号分割;size:200;"example:"1,2"` //话题_编号,通过逗号分割
	...
	IsAddActivity int                  `json:"isAddActivity" gorm:"-"`                                             //是否参加活动：0否、1是
}
