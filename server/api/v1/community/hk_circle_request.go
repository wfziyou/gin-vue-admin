...
// @accept application/json
// @Produce application/json
// @Param data query community.HkCircleRequest true "用id查询HkCircleRequest"
...
func (hkCircleRequestApi *HkCircleRequestApi) FindHkCircleRequest(c *gin.Context) {
	var hkCircleRequest community.HkCircleRequest
	err := c.ShouldBindQuery(&hkCircleRequest)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
	if rehkCircleRequest, err := hkCircleRequestService.GetHkCircleRequest(hkCircleRequest.ID); err != nil {
