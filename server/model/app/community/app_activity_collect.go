...
// HkActivityCollect 结构体
type HkActivityCollect struct {
      global.GVA_MODEL
...
// TableName HkActivityCollect 表名
func (HkActivityCollect) TableName() string {
  return "hk_activity_collect"
}
