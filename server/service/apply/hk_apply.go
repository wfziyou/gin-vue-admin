...
type HkApplyService struct {
}

// CreateHkApply 创建HkApply记录
// Author [piexlmax](https://github.com/piexlmax)
func (hkApplyService *HkApplyService) CreateHkApply(hkApply apply.HkApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkApplyService *HkApplyService) DeleteHkApply(hkApply apply.HkApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkApplyService *HkApplyService) DeleteHkApplyByIds(ids request.IdsReq) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkApplyService *HkApplyService) UpdateHkApply(hkApply apply.HkApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkApplyService *HkApplyService) GetHkApply(id uint) (hkApply apply.HkApply, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkApplyService *HkApplyService) GetHkApplyInfoList(info applyReq.HkApplySearch) (list []apply.HkApply, total int64, err error) {
	limit := info.PageSize
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkApplyService *HkApplyService) GetHkApplyInfoListAll(info applyReq.HkApplySearchAll) (list []apply.HkApply, total int64, err error) {
	// 创建db
	db := global.GVA_DB.Model(&apply.HkApply{})
	var hkApplys []apply.HkApply
	// 如果有条件搜索 下方会自动创建搜索语句
