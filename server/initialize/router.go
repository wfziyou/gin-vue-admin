...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		appRouter.InitGeneralRouter(PrivateGroup)
		appRouter.InitReportRouter(PrivateGroup)
		appRouter.InitTopicRouter(PrivateGroup)
		appRouter.InitUserRouter(PrivateGroup)
		appRouter.InitUserBrowsingHistoryRouter(PrivateGroup)
		...
		appRouter.InitActivityAddRequestRouter(PrivateGroup)
	}
