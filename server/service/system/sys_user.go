...
func (userService *UserService) GetUserInfo(userId uint64) (user system.SysUser, err error) {
	var reqUser system.SysUser
	err = global.GVA_DB.Preload("Authorities").Preload("Authority").First(&reqUser, "id = ?", userId).Error
	if err != nil {
		return reqUser, err
	}
