...
type HkPlatApplyService struct {
}

// CreateHkPlatApply 创建HkPlatApply记录
// Author [piexlmax](https://github.com/piexlmax)
func (hkPlatApplyService *HkPlatApplyService) CreateHkPlatApply(hkPlatApply apply.HkPlatApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkPlatApplyService *HkPlatApplyService)DeleteHkPlatApply(hkPlatApply apply.HkPlatApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkPlatApplyService *HkPlatApplyService)DeleteHkPlatApplyByIds(ids request.IdsReq) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkPlatApplyService *HkPlatApplyService)UpdateHkPlatApply(hkPlatApply apply.HkPlatApply) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkPlatApplyService *HkPlatApplyService)GetHkPlatApply(id uint) (hkPlatApply apply.HkPlatApply, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (hkPlatApplyService *HkPlatApplyService)GetHkPlatApplyInfoList(info applyReq.HkPlatApplySearch) (list []apply.HkPlatApply, total int64, err error) {
	limit := info.PageSize
